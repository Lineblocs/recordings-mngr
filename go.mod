module lineblocs.com/recordings-mngr
...
require (
	...
	github.com/clockworksoul/smudge v1.0.0 // indirect
	...
	github.com/mailgun/mailgun-go/v4 v4.1.3 // indirect
...
replace github.com/CyCoreSystems/ari/v5 => github.com/nadirhamid/ari/v5 v5.2.2
